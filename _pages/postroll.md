...
On this postroll page—inspired by [Brandon's](https://wand3r.net/blogroll-slashpage/)—I'll list *n* share-worthy posts, aiming to add two or more new posts a week. This means that older entries will eventually cycle out of the list. (As of 2024-07-05, I'm still deciding how many *n* will equal, a number which will almost certainly intertwingle with how quickly I add new posts.)  

This approach is not quite analogous to a mixtape full of things that work well together, but it will hopefully highlight particular posts in a different way than [my blogroll page]({{ site.url }}/blogroll/)'s more general "hey, check out this feed (or band / musician)" can do.  
